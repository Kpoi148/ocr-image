...
## Performance and caching
- **Profile sequence**: The default offscreen pipeline runs document, adaptive-threshold document, sparse screenshot, and inverted profiles, then chooses the strongest candidate from structured OCR output.
